...
BalanceReports::BalanceReports(double t_initialInvestment,
...
bool BalanceReports::checkInput() {
...
void BalanceReports::displayInput() {
	cout << "**********************************" << endl;
	cout << "**********  Data Input  **********" << endl;
	...
	cout << endl << "Press any key and enter to continue" << endl<< endl;
	cin >> pause;

}

// Print Balance Report (with or without additional deposits.
void BalanceReports::displayBalanceReports(bool t_additionalDeposits) {
